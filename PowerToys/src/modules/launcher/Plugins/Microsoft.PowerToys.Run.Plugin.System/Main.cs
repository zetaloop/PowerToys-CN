            ...
            results.AddRange(new[]
            {
                ...
                new Result
                {
                    ...
                    Action = c =>
                    {
                        ...
                        {
                            var name = "插件: " + Properties.Resources.Microsoft_plugin_sys_plugin_name;
                            var message = $"清空回收站失败，错误代码: {result}\n" +
                                          "请参考 https://msdn.microsoft.com/en-us/library/windows/desktop/aa378137";
