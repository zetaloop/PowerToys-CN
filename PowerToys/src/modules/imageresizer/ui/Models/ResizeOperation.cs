    ...
    internal class ResizeOperation
    {
        ...
        private BitmapSource Transform(BitmapSource source)
        {
            ...
            if (_settings.IgnoreOrientation
                ...
                && _settings.SelectedSize.Unit != ResizeUnit.百分比
            ...
            if (_settings.SelectedSize.Fit == ResizeFit.缩放)
            {
                scaleX = Math.Min(scaleX, scaleY);
                scaleY = scaleX;
            }
            else if (_settings.SelectedSize.Fit == ResizeFit.填充)
            {
            ...
            if (_settings.SelectedSize.Fit == ResizeFit.填充
