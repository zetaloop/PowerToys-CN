...
namespace ImageResizer.Properties
{
    public sealed partial class Settings : IDataErrorInfo, INotifyPropertyChanged
    {
        ...
        public Settings()
        {
            ...
            {
                new ResizeSize("$small$", ResizeFit.缩放, 854, 480, ResizeUnit.像素),
                new ResizeSize("$medium$", ResizeFit.缩放, 1366, 768, ResizeUnit.像素),
                new ResizeSize("$large$", ResizeFit.缩放, 1920, 1080, ResizeUnit.像素),
                new ResizeSize("$phone$", ResizeFit.缩放, 320, 568, ResizeUnit.像素),
            };
            KeepDateModified = false;
            FallbackEncoder = new System.Guid("19e4a5aa-5662-4fc5-a0c0-1758028e1057");
            CustomSize = new CustomSize(ResizeFit.缩放, 1024, 640, ResizeUnit.像素);
