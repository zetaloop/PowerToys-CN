    ...
    public class ResizeOperationTests : IDisposable
    {
            ...
            var operation = new ResizeOperation(
                ...
                Settings(
                    x =>
                    {
                        ...
                        x.SelectedSize.Unit = ResizeUnit.百分比;
                        x.SelectedSize.Fit = ResizeFit.拉伸;
                    }));
            ...
            var operation = new ResizeOperation(
                ...
                Settings(
                    x =>
                    {
                        ...
                        x.SelectedSize.Unit = ResizeUnit.英寸;
                    }));
        ...
        public void TransformHonorsFitWhenFit()
        {
            var operation = new ResizeOperation(
                "Test.png",
                _directory,
                Settings(x => x.SelectedSize.Fit = ResizeFit.缩放));
        ...
        public void TransformHonorsFitWhenFill()
        {
            var operation = new ResizeOperation(
                "Test.png",
                _directory,
                Settings(x => x.SelectedSize.Fit = ResizeFit.填充));
        ...
        public void TransformHonorsFitWhenStretch()
        {
            var operation = new ResizeOperation(
                "Test.png",
                _directory,
                Settings(x => x.SelectedSize.Fit = ResizeFit.拉伸));
