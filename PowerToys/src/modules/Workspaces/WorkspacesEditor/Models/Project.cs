    ...
    public class Project : INotifyPropertyChanged
    {
        ...
        public List<object> ApplicationsListed
        {
            get
            {
                ...
                {
                    MonitorHeaderRow headerRow = new MonitorHeaderRow { MonitorName = "显示器 " + appItem.Key.MonitorNumber, SelectString = Properties.Resources.SelectAllAppsOnMonitor.Replace("{0}", appItem.Key.MonitorInfo) };
