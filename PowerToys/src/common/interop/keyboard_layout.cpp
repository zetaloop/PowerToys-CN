...
void LayoutMap::LayoutMapImpl::UpdateLayout()
{
    ...
    keyboardLayoutMap[VK_SUBTRACT] = L"- (Ð¡¼üÅÌ)";
    ...
    keyboardLayoutMap[VK_NUMPAD0] = L"0 (Ð¡¼üÅÌ)";
    keyboardLayoutMap[VK_NUMPAD1] = L"1 (Ð¡¼üÅÌ)";
    keyboardLayoutMap[VK_NUMPAD2] = L"2 (Ð¡¼üÅÌ)";
    keyboardLayoutMap[VK_NUMPAD3] = L"3 (Ð¡¼üÅÌ)";
    keyboardLayoutMap[VK_NUMPAD4] = L"4 (Ð¡¼üÅÌ)";
    keyboardLayoutMap[VK_NUMPAD5] = L"5 (Ð¡¼üÅÌ)";
    keyboardLayoutMap[VK_NUMPAD6] = L"6 (Ð¡¼üÅÌ)";
    keyboardLayoutMap[VK_NUMPAD7] = L"7 (Ð¡¼üÅÌ)";
    keyboardLayoutMap[VK_NUMPAD8] = L"8 (Ð¡¼üÅÌ)";
    keyboardLayoutMap[VK_NUMPAD9] = L"9 (Ð¡¼üÅÌ)";
    ...
    keyboardLayoutMap[VK_DECIMAL] = L". (Ð¡¼üÅÌ)";
