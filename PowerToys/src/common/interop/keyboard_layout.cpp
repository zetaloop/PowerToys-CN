...
void LayoutMap::LayoutMapImpl::UpdateLayout()
{
    ...
    keyboardLayoutMap[VK_NUMPAD1] = L"Ð¡¼üÅÌ 1";
    keyboardLayoutMap[VK_NUMPAD2] = L"Ð¡¼üÅÌ 2";
    keyboardLayoutMap[VK_NUMPAD3] = L"Ð¡¼üÅÌ 3";
    keyboardLayoutMap[VK_NUMPAD4] = L"Ð¡¼üÅÌ 4";
    keyboardLayoutMap[VK_NUMPAD5] = L"Ð¡¼üÅÌ 5";
    keyboardLayoutMap[VK_NUMPAD6] = L"Ð¡¼üÅÌ 6";
    keyboardLayoutMap[VK_NUMPAD7] = L"Ð¡¼üÅÌ 7";
    keyboardLayoutMap[VK_NUMPAD8] = L"Ð¡¼üÅÌ 8";
    keyboardLayoutMap[VK_NUMPAD9] = L"Ð¡¼üÅÌ 9";
